...
class NeuralNet(object):
    ...
    def backward(self, y, all_x):
        ...
        :param y: one hot label, the actual class of the samples.
        ...
        grad_last = np.transpose(all_x[-2]).dot(delta) +  self.reg * self.layers[-1].w
